...
$mysqli = new mysqli('sql9.freesqldatabase.com', 'sql9353803', 'eYubggSyxT', 'sql9353803');
...
// $sql = "SELECT actor_id, first_name, last_name FROM actor WHERE actor_id = $aid";
    $sql = "SELECT id, nombre FROM grado";
...
echo "Sometimes I see " . $actor['id'] . " " . $actor['nombre'] . " on TV.";
...
$sql = "SELECT id,nombre, grade FROM alumnos LIMIT 5";
if (!$result = $mysqli->query($sql)) {
    echo "Sorry, the website is experiencing problems.";
    exit;
}
